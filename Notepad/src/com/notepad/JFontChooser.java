...
/*
 * Got the code from http://stackoverflow.com/questions/2120228/java-swing-font-chooser
 */
    ...
    public JTextField getFontFamilyTextField()
    {
        if (fontFamilyTextField == null)
        {
            ...
            fontFamilyTextField.getDocument().addDocumentListener(
                (DocumentListener) new ListSearchTextFieldDocumentHandler(getFontFamilyList()));
